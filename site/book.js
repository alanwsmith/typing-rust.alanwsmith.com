...
;(function codeSnippets() {
  ...
  function handle_crate_list_update(playground_block, playground_crates) {
    ...
    if (window.ace) {
      // TEST to see if you can get an option here
  ...
  function update_play_button(pre_block, playground_crates) {
    ...
    // This is how to hide the play button if you
  ...
  Array.from(document.querySelectorAll('code.language-rust')).forEach(function (
    ...
    /* 
        * REMOVE THE Show Hidden Lines BUTTON
        *
  ...
  Array.from(document.querySelectorAll('.playground')).forEach(function (
    ...
    runCodeButton.className = 'fa'
    runCodeButton.hidden = true
    runCodeButton.innerHTML = 'Run'
    runCodeButton.title = 'Run'
  ...
  function set_theme(theme, store = true) {
    ...
    if (window.ace && window.editors) {
      window.editors.forEach(function (editor) {
        ...
        // This turns off auto closing of brackets
        // It also turns off auto tabbing, but that's
        // fine.
        editor.setOption('behavioursEnabled', false)
        //
        // Setting tabsize to 2 to match prettier
        // formatting from the markdown docs
